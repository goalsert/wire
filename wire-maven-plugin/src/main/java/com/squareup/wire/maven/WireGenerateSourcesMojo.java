 ...
 *
 * For now just finds all proto files. The plugin attaches itself to the generate
 *
 * {@see http://maven.apache.org/developers/mojo-api-specification.html}
 *
 * Maven plugin configuration and defaults
 */
...
public class WireGenerateSourcesMojo extends AbstractMojo {
  ...
  @Parameter(
      ...
      defaultValue = "${project.basedir}/target/generated-sources/wire")
